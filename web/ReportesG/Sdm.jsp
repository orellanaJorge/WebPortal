...
<head>
	<title>Subsidio Discapacidad Mental</title>
...
<tr>
		      <td width="930"><img src="../images/T_sdm.jpg" width="537" height="25" /></td>
		      <td width="54">
              <form action="../ReportesG_XLS/SdmXLS.jsp" method="post" name="form2" id="form2">
